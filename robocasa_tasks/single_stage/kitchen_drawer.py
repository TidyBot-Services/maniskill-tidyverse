...
@register_env("RoboCasa-Open-Drawer-v0", max_episode_steps=300, asset_download_ids=["RoboCasa"])
...
@register_env("RoboCasa-Close-Drawer-v0", max_episode_steps=300, asset_download_ids=["RoboCasa"])
