...
@register_env("RoboCasa-Pn-P-Coffee-v0", max_episode_steps=300, asset_download_ids=["RoboCasa"])
...
@register_env("RoboCasa-Coffee-Serve-Mug-v0", max_episode_steps=300, asset_download_ids=["RoboCasa"])
...
@register_env("RoboCasa-Coffee-Press-Button-v0", max_episode_steps=300, asset_download_ids=["RoboCasa"])
