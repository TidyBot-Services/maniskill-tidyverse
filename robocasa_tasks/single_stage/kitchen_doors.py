...
@register_env("RoboCasa-Open-Door-v0", max_episode_steps=300, asset_download_ids=["RoboCasa"])
class OpenDoor(ManipulateDoor):
    def __init__(self, *args, **kwargs):
        super().__init__(behavior="open", *args, **kwargs)


@register_env("RoboCasa-Open-Single-Door-v0", max_episode_steps=300, asset_download_ids=["RoboCasa"])
