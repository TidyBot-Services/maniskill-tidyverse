...
@register_env("RoboCasa-Manipulate-Stove-Knob-v0", max_episode_steps=300, asset_download_ids=["RoboCasa"])
...
@register_env("RoboCasa-Turn-On-Stove-v0", max_episode_steps=300, asset_download_ids=["RoboCasa"])
class TurnOnStove(ManipulateStoveKnob):
    def __init__(self, *args, **kwargs):
        super().__init__(behavior="turn_on", *args, **kwargs)


@register_env("RoboCasa-Turn-Off-Stove-v0", max_episode_steps=300, asset_download_ids=["RoboCasa"])
