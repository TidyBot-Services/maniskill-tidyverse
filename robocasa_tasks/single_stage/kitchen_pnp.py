...
@register_env("RoboCasa-Pn-P-v0", max_episode_steps=300, asset_download_ids=["RoboCasa"])
class PnP(Kitchen):
    """
...
@register_env("RoboCasa-Pn-P-Counter-To-Cab-v0", max_episode_steps=300, asset_download_ids=["RoboCasa"])
