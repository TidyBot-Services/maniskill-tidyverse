...
@register_env("RoboCasa-Manipulate-Sink-Faucet-v0", max_episode_steps=300, asset_download_ids=["RoboCasa"])
...
@register_env("RoboCasa-Turn-On-Sink-Faucet-v0", max_episode_steps=300, asset_download_ids=["RoboCasa"])
class TurnOnSinkFaucet(ManipulateSinkFaucet):
    def __init__(self, *args, **kwargs):
        super().__init__(behavior="turn_on", *args, **kwargs)


@register_env("RoboCasa-Turn-Off-Sink-Faucet-v0", max_episode_steps=300, asset_download_ids=["RoboCasa"])
class TurnOffSinkFaucet(ManipulateSinkFaucet):
    def __init__(self, *args, **kwargs):
        super().__init__(behavior="turn_off", *args, **kwargs)


@register_env("RoboCasa-Turn-Sink-Spout-v0", max_episode_steps=300, asset_download_ids=["RoboCasa"])
