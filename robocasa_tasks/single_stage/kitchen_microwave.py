...
@register_env("RoboCasa-Microwave-Press-Button-v0", max_episode_steps=300, asset_download_ids=["RoboCasa"])
...
@register_env("RoboCasa-Turn-On-Microwave-v0", max_episode_steps=300, asset_download_ids=["RoboCasa"])
...
@register_env("RoboCasa-Turn-Off-Microwave-v0", max_episode_steps=300, asset_download_ids=["RoboCasa"])
